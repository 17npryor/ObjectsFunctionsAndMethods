...
def try_methods_and_functions():
    ...
    """
    dill = rg.SimpleTurtle()
    dill.pen = rg.Pen('blue', 5)
    dill.backward(150)
    dill.speed = 1
    draw_many_squares(dill, 2, 100, 30)
    dill.speed = 5
    dill.pen = rg.Pen('red', 5)
    draw_many_squares(dill, 10, 50, 15)
    dill.speed = 100
    dill.pen = rg.Pen('red', 35)
    draw_many_squares(dill, 8, 300, 60)
    dill.pen = rg.Pen('black', 3)
    dill.backward(200)
    dill.draw_circle(30)
    dill.draw_square(50)
    ####################################################################
